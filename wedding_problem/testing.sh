...
python3 $FILE_NAME given/64_16.in >> "results/$FILE_NAME 64_16"
python3 $FILE_NAME given/99_33.in >> "results/$FILE_NAME 99_33"
python3 $FILE_NAME given/100_10.in >> "results/$FILE_NAME 100_10"
python3 $FILE_NAME given/100_20.in >> "results/$FILE_NAME 100_20"
